...
NoObjetos = int(input('Por favor escriba el numero de objetos que va a crear entre 0 y 1 al azar: '))
TamContexto = int(input('Por favor escriba cuantos objetos va a sacar al azar de la lista de objetos totales, con los cuales va a correr juego_discriminacion: '))
Ronda = int(input('Por favor escriba el numero de rondas que desea que la maquina ejecute juego_discriminacion: '))
...
Arbol, vict , derr = Rondas_100(Ronda, Objetos)
